...
/**
 * bottone per la vsaulizzazione delle strutture prenotae
 * {@param BookedStructures} parametro che implementa il button per la visualizzazione delle strutture prenotate
 */
